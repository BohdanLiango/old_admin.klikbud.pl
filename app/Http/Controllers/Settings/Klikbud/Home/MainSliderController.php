...
class MainSliderController extends AdminController
{
     ...
     */
    public function __construct(MainSliderService $mainSliderService, BreadcrumbsData $breadcrumbsData, DefaultData $defaultData)
    {
        parent::__construct();
    ...
    public function show()
    {
        ...
        return view('pages.settings.klikbud.home.mainslider.content', compact('sliders', 'breadcrumbs', 'page_title'));
    }
}
