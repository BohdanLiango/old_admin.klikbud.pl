                ...
                <div class="row">
                    ...
                    <div class="col-xl-8">
                        <div class="my-5">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input class="form-control form-control-solid  @error('title') is-invalid @enderror"
                                           type="text" placeholder="{{ trans('admin_klikbud/objects.add_edit_page.title_placeholder') }}" wire:model.lazy="title"/>
                            ...
                            <div class="form-group row">
                                <label class="col-3">{{ trans('admin_klikbud/objects.add_edit_page.status_object') }}<span class="text-danger">*</span></label>
                                <div class="col-9">
                                    <div wire:ignore>
                            ...
                            <div class="form-group row">
                                <label class="col-3">{{ trans('admin_klikbud/objects.add_edit_page.type_object') }}<span class="text-danger">*</span></label>
                                <div class="col-9">
                                    <div wire:ignore>
                            ...
                            <div class="form-group row">
                                <label class="col-3">{{ trans('admin_klikbud/objects.add_edit_page.type_repair') }}<span class="text-danger">*</span></label>
                                <div class="col-9">
                                    <div wire:ignore>
