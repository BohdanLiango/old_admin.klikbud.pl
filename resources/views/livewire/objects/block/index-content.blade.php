    ...
    <div class="col-xl-6">
        <div class="card card-custom gutter-b card-stretch">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column mr-auto">
                        <a href="#" class="card-title text-hover-primary font-weight-bolder font-size-h5 text-dark mb-1">{{ $object->title }}</a>
                        @if(!is_null($object->client))
                        <span class="text-muted font-weight-bold">Klient: <a href="{{ route('clients.one', $object->client_id) }}" target="_blank">{{ $object->client->first_name }} {{ $object->client->last_name }}</a></span>
                        @endif
                    </div>
                        ...
                        <div class="dropdown dropdown-inline" data-toggle="tooltip" data-placement="left">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                <ul class="navi navi-hover">
                                    ...
                                    <li class="navi-item"><a href="#" class="navi-link"><span class="navi-icon"><i class="flaticon2-shopping-cart-1"></i></span><span class="navi-text">Dostawe</span></a></li>
                                    <li class="navi-item"><a href="#" class="navi-link"><span class="navi-icon"><i class="flaticon2-calendar-8"></i></span><span class="navi-text">Komentaz</span></a></li>
                                    <li class="navi-item"><a href="#" class="navi-link"><span class="navi-icon"><i class="flaticon2-graph-1"></i></span><span class="navi-text">Statystyka</span></a></li>
                                    <li class="navi-item"><a href="#" class="navi-link"><span class="navi-icon"><i class="flaticon2-rocket-1"></i></span><span class="navi-text">Wydatek</span></a></li>
                                    <li class="navi-item"><a href="#" class="navi-link"><span class="navi-icon"><i class="flaticon2-writing"></i></span><span class="navi-text">File</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex flex-wrap mt-14">
                    <div class="mr-12 d-flex flex-column mb-7">
                        ...
                        <span class="btn btn-light-primary btn-sm font-weight-bold btn-upper btn-text">{{ date('d/m/Y', strtotime($object->date_start)) }}</span>
                    </div>
                    <div class="mr-12 d-flex flex-column mb-7">
                        <span class="d-block font-weight-bold mb-4">Due Date</span>
                        <span class="btn btn-light-danger btn-sm font-weight-bold btn-upper btn-text">{{ date('d/m/Y', strtotime($object->date_end)) }}</span>
                    </div>
                ...
                <div class="d-flex flex-wrap">
                    <div class="mr-12 d-flex flex-column mb-7">
                        <span class="font-weight-bolder mb-4">price_start</span>
                        @if(!is_null($object->price_start))
                        <span class="font-weight-bolder font-size-h5 pt-1">{{ $object->price_start }} <span class="font-weight-bold text-dark-50">zł</span></span>
                        @endif
                    </div>
                    <div class="mr-12 d-flex flex-column mb-7">
                        <span class="font-weight-bolder mb-4">price_end</span>
                        @if(!is_null($object->price_end))
                        <span class="font-weight-bolder font-size-h5 pt-1">{{ $object->price_end }} <span class="font-weight-bold text-dark-50">zł</span></span>
                        @endif
                    </div>
                    <div class="d-flex flex-column flex-lg-fill float-left mb-7">
                        <span class="font-weight-bolder mb-4">Employeers</span>
            ...
            <div class="card-footer d-flex align-items-center">
                ...
                <a href="{{ route('objects.one', $object->id) }}" class="btn btn-primary btn-sm text-uppercase font-weight-bolder mt-5 mt-sm-0 mr-auto mr-sm-0 ml-sm-auto">details</a>
            </div>
        </div>
    </div>
    @empty
