            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                <div class="d-flex align-items-center flex-wrap mr-2">
                    ...
                    <div class="d-flex align-items-center" id="kt_subheader_search">
                        <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">{{ $count_all }} Total</span>
                        <form class="ml-5">
                ...
                <div class="d-flex align-items-center">
                    <a href="#" class=""></a>
                    <a href="{{ route('objects.add') }}" class="btn btn-light-primary font-weight-bold ml-2">Add Project</a>
                </div>
            </div>
        </div>
               ...
               @include('livewire.objects.block.index-content')
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <span class="text-muted">Displaying {{ $paginate }} of 230 records</span>
                    </div>
                </div>
            </div>
        </div>
