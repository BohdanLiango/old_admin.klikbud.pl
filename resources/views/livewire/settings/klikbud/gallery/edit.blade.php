                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8">
                                <div class="my-5">
                                    ...
                                    @elseif(isset($oldPhoto))
                                        <div class="form-group row">
                                            <label for="image" class="col-3"></label>
                                            <div class="col-9">
                                                <img src="{{Storage::disk(config('klikbud.disk_store'))->url($oldGallery->image->path) }}" style="width: 300px">
                                            </div>
                                        </div>
                                    @endif
                                ...
                                <button type="submit" class="btn btn-success">  <i class="ki ki-check icon-xs"></i>{{ trans('admin_klikbud/settings/klikbud/gallery.form.edit') }}</button>
                            </div>
