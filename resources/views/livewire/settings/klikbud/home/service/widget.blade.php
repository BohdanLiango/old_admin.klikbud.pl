    ...
    <div class="card card-custom gutter-b" style="height: 200px;">
        ...
        <div class="card-body d-flex flex-column">
            <div class="d-flex align-items-center justify-content-between flex-grow-1">
                <div class="mr-2">
                    <h3 class="font-weight-bolder">{{ trans('admin_klikbud/settings/klikbud/service.show.widget.count_sliders') }}</h3>
                    <div class="text-muted font-size-lg mt-2">
                        {{ trans('admin_klikbud/settings/klikbud/service.show.widget.active') }}
                        <b>{{ $count }} </b> - ({{ $percent_all_active }}%)
                        <br>
                        {{ trans('admin_klikbud/settings/klikbud/service.show.widget.deleted') }}
                        <b>{{ $count_deleted }}</b> - ({{ $percent_all_deleted }}%)
                    </div>
                </div>
                <div class="font-weight-boldest font-size-h1 text-info">{{ $all_services }}</div>
            </div>
            <div class="pt-8">
...
<div class="col-xl-4">
    ...
    <div class="card card-custom gutter-b" style="height: 200px;">
        ...
        <div class="card-body d-flex flex-column">
            <div class="d-flex align-items-center justify-content-between flex-grow-1">
                <div class="mr-2">
                    <h3 class="font-weight-bolder">{{ trans('admin_klikbud/settings/klikbud/service.show.widget.active') }}</h3>
...
<div class="col-xl-4">
    ...
    <div class="card card-custom gutter-b" style="height: 200px;">
        ...
        <div class="card-body d-flex flex-column">
            <div class="d-flex align-items-center justify-content-between flex-grow-1">
                <div class="mr-2">
                    <h3 class="font-weight-bolder">{{ trans('admin_klikbud/settings/klikbud/service.show.widget.hidden') }}</h3>
                    <div class="text-muted font-size-lg mt-2"></div>
                </div>
