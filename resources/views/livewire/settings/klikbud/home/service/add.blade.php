            ...
            <div class="card-header">
                <div class="card-toolbar float-left">
                    <a href="{{ route('settings.klikbud.home.service.index') }}" class="btn btn-light-primary font-weight-bolder mr-2">
                        <i class="ki ki-long-arrow-back icon-xs"></i>{{ trans('admin_klikbud/settings/klikbud/service.create.back') }}
                    </a>
                    @if($errors->any())
                            ...
                            <div class="my-5">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        ...
                                        @error('service.title_pl')<div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>
                                </div>
                            ...
                            <div class="my-5">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        ...
                                        @error('service.title_en')<div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        ...
                                        @error('service.title_ua')<div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        ...
                                        @error('service.title_ru')<div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>
                                </div>
