                        ...
                        <div class="col-xl-8">
                            <div class="my-5">
                                ...
                                <div class="form-group row">
                                    <label class="col-3">Żółty napis<span class="text-danger">*</span></label>
                                    <div class="col-9">
                                        <input class="form-control" type="text" value="" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-3">Czarny napis<span class="text-danger">*</span></label>
                                    <div class="col-9">
                                        <input class="form-control" type="text" value="" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-3">Numer suwaka<span class="text-danger">*</span></label>
                                    <div class="radio-inline col-9">
                                        <label class="radio">
                                            <input type="radio" name="slider_number_show" value="1"/>
                                            <span></span>
                                            1
                                        </label>
                                        <label class="radio">
                                            <input type="radio" name="slider_number_show" value="2"/>
                                            <span></span>
                                            2
                                        </label>
                                        <label class="radio">
                                            <input type="radio" name="slider_number_show" value="3"/>
                                            <span></span>
                                            3
                                        </label>
                                        <label class="radio">
                                            <input type="radio" name="slider_number_show" value="4"/>
                                            <span></span>
                                            4
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <textarea class="form-control col-9" id="exampleTextarea" rows="2"></textarea>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-3">CEO<span class="text-danger">*</span></label>
                                    <div class="col-9">
