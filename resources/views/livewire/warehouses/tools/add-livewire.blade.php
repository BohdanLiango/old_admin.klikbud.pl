    ...
    <div class="card card-custom card-sticky" id="kt_page_sticky_card">
        <div wire:ignore class="card-header">
            <div class="card-title">
                <h3 class="card-label">
                    {{ trans('admin_klikbud/warehouse/tools.add_edit.add_title') }}
                </h3>
            </div>
            <div class="card-toolbar">
                ...
                <div class="btn-group">
                    <button type="button" wire:click="store({{ 1 }})" class="btn btn-primary font-weight-bolder">
                        ...
                        {{ trans('admin_klikbud/warehouse/tools.add_edit.buttons.save_form') }}
                    </button>
                        ...
                        <ul class="nav nav-hover flex-column">
                            <li class="nav-item">
                                <a href="#" wire:click="store({{2}})" class="nav-link">
                                    ...
                                    <span class="nav-text">{{ trans('admin_klikbud/warehouse/tools.add_edit.buttons.save') }} & {{ trans('admin_klikbud/warehouse/tools.add_edit.buttons.save_continue') }}</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#" wire:click="store({{3}})" class="nav-link">
                                    <i class="nav-icon flaticon2-add-1"></i>
                                    <span class="nav-text">{{ trans('admin_klikbud/warehouse/tools.add_edit.buttons.save') }} & {{ trans('admin_klikbud/warehouse/tools.add_edit.buttons.save_add') }}</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#" wire:click="store({{1}})" class="nav-link">
                                    <i class="nav-icon flaticon2-power"></i>
                                    <span class="nav-text">{{ trans('admin_klikbud/warehouse/tools.add_edit.buttons.save') }} & {{ trans('admin_klikbud/warehouse/tools.add_edit.buttons.save_exit') }}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8">
                        <div class="my-5">
                            ...
                            <div class="form-group row">
                                <label class="col-3" for="business_departments_id">{{ trans('admin_klikbud/warehouse/tools.add_edit.form.where_buy') }}</label>
                                <div class="col-9">
                                    <div wire:ignore>
