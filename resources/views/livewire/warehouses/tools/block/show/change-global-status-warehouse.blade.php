        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    <label for="warehouse" class="col-form-label text-right col-lg-3 col-sm-12">Warehouse</label>
            ...
            <div class="modal-footer">
                <button wire:click="selectModal('closeChangeWarehouse')" type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
