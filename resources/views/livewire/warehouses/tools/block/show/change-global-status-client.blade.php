<div wire:ignore.self class="modal fade" id="globalStatusClients" tabindex="-1" role="dialog" aria-labelledby="addModal"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ trans('admin_klikbud/warehouse/tools.one.modals.client_change') }}</h5>
            ...
            <div class="modal-footer">
                <button wire:click="selectModal('closeChangeClient')" type="button" class="btn btn-secondary" data-dismiss="modal">{{ trans('admin_klikbud/warehouse/tools.one.modals.close') }}</button>
