        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">
                    {{ trans('admin_klikbud/warehouse/toolsCategory.index.delete_modal.title') }} {{ $deleteCategoryTitle }} {{ $deleteTitle }} ?
                </h5>
            ...
            <div class="modal-footer">
                <button wire:click="resetFields()" type="button" class="btn btn-secondary">{{ trans('admin_klikbud/clients.one.delete_modal.no') }}</button>
