<div>
    ...
    <tr>
        <td>
            <a href="#" class="text-dark fw-bolder text-hover-primary fs-6">{{ $add->id }}</a>
        </td>
        <td>
        ...
        <td>
            <a href="#" class="text-dark fw-bolder text-hover-primary d-block mb-1 fs-6">{{ $add->user->name }} {{ $add->user->surname }}</a>
            <span class="text-muted fw-bold text-muted d-block fs-7">{{ $add->created_at->format('H:i:s d/m/Y') }}</span>
        </td>
