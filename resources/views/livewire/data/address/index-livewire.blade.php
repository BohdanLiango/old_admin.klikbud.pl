            ...
            <div class="table-responsive">
                ...
                <tr>
                    ...
                    <td class="text-end">
                        ...
                        @if($add->type_id !== config('app.address.street'))
                            <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" wire:click="selectModal('openAddNewAddress', {{ json_encode($add->id) }}, {{ json_encode($add->type_id) }})">
