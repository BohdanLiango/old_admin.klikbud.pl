<div>
            ...
            <div class="table-responsive">
                ...
                <tr>
                    ...
                    <td class="text-end">
                        ...
                        <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" wire:click="selectEditModal('openEditAddress', {{ $add->id }}, {{ $add->title }})">
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('openEditAddress', event => {
            $("#editAddress").modal('show')
        })
        window.addEventListener('closeEditAddress', event => {
