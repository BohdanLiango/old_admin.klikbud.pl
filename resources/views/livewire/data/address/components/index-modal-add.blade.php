    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ trans('data/address/add.add') }} {{ $addModalTitle }}</h5>
                    <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close" wire:click.prevent="selectModal('closeAddNewAddress', {{ NULL }}, {{ NULL }})">
            ...
            <div class="modal-body">
                <label>
                    <input type="text" name="title" class="form-control form-control-flush" wire:model="addTitle" placeholder="{{ $addModalTitle }}"/>
                </label>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal" wire:click="selectModal('closeAddNewAddress', {{ NULL }}, {{ NULL }})">{{ trans('data/address/add.close') }}</button>
                <button type="button" class="btn btn-success" wire:click="save()">{{ trans('data/address/add.save') }}</button>
            </div>
        </div>
    </div>
</div>
